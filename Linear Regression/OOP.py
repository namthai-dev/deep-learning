# On a high level we wish to have three classes: 
# (i) Module contains models, losses, and optimization methods; 
# (ii) DataModule provides data loaders for training and validation; 
# (iii) both classes are combined using the Trainer class, which allows us 
# to train models on a variety of hardware platforms.
import time
import numpy as np
import torch
...
# Allows us to plot experiment progress interactively while it is going on
